                            ...
                            <li class="product-item">
                                <div class="product product-widget-style">
                                    ...
                                    <div class="product-info">
                                        <a href="{{ route('product.details',['slug' => $popular_product->slug]) }}" class="product-name"><span>{{ $popular_product->product_name }}</span></a>
                            ...
                            <div class="product product-style-2 equal-elem ">
                                <div class="product-thumnail">
                                    <a href="{{ route('product.details',['slug' => $related_product->slug]) }}" title="T-Shirt Raw Hem Organic Boro Constrast Denim">
                                        <figure><img src="{{ asset('assets/images/products') }}/{{ $related_product->image }}" width="214" height="214" alt="{{ $related_product->product_name }}"></figure>
                                    </a>
