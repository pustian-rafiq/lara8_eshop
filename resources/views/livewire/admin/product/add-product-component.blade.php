 ...
 <div class="container-fluid" style=" box-shadow: rgba(0, 0, 0, 0.16) 0px 3px 6px, rgba(0, 0, 0, 0.23) 0px 3px 6px;">
   <div class="row" style="box-shadow: rgba(0, 0, 0, 0.35) 0px 5px 15px;">
     ...
     <div class="col-md-4">
        <a class="btn btn-success pull-right mt-2" href="{{ route('admin.products') }}" style="color:#fff">All Products</a>
    </div>
   </div>
   <div class="row p-5">
                ...
                <div class="col-md-6">
                    ...
                    <div class=" mb-3">
                        <label for="inputEmail3">Product Category</label>
                         <select class="form-control" name="product_category" wire:model="product_category" id="inputEmail3">
                ...
                <div class="col-md-6">
                    ...
                    <div class=" mb-3">
                        <label for="inputEmail3">Image</label>
                          <input type="file" class="form-control" id="inputEmail3" wire:model="product_image">
                          @if($product_image)
                          <img src="{{ $product_image->temporaryUrl() }}" alt="" width="120">
                          @endif
